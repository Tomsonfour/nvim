...
vim.api.nvim_create_autocmd('FileType', {
  pattern = 'python',
  callback = function()
    vim.api.nvim_buf_set_keymap(0, 'n', '<leader>r', ':w<CR>:!python %<CR>', { noremap = true, silent = true })
  end,
})
...
vim.api.nvim_create_autocmd('FileType', {
  pattern = 'c',
  callback = function()
    vim.api.nvim_buf_set_keymap(0, 'n', '<leader>r', ':w<CR>:!gcc % -o %:r.app && ./%:r.app  <CR>:', { noremap = true, silent = true })
  end,
})
